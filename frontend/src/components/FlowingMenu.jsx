...
function MenuItem({ link, text, image, onClick, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, isFirst }) {
  ...
  useEffect(() => {
    ...
    const updateHoverState = event => setCanHover(event.matches);
  ...
  const linkProps = isInternalLink ? { to: link } : { href: link };
    ...
    <div
      ...
      <div
        ...
        style={{
          ...
          transform: canHover ? undefined : 'translateY(0%)'
        }}>
        <div
          className="h-full w-fit flex"
          ref={marqueeInnerRef}
          style={{ transform: canHover ? undefined : 'translateY(0%)' }}>
